...
output: 
  flexdashboard::flex_dashboard:
    ...
    includes:
      ...
      after_body: ../../html/myNEAfooter.html
    css: ../../www/styles.css
params:
...
htmltools::includeHTML("ndec.html")
...
### **Evaluated Files That are different from previous release**{data-width=600}


```{r table_diffs}

lib2 <-data.table::fread('../../csv/JEFF33_vs_JEFF32.csv', header = TRUE, sep = ",", stringsAsFactors = TRUE) %>% # RELATIVE PATH
