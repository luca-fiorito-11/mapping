...
### Evaluations with MF `r selected_MF` in `r paste(params$LIB,params$VER,sep='-')` {data-width=200}
```{r}
...
### Origin histogram of MF `r selected_MF` sections found in `r paste(params$LIB,params$VER,sep='-')` {data-width=400}
```{r}
